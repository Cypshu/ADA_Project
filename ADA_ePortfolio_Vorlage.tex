...
% ------------------------------------------------------------------------------
% INHALTS- UND BESTANDTEILÜBERSICHT
% ------------------------------------------------------------------------------
\section*{Inhalts- und Bestandteilübersicht}
\addcontentsline{toc}{section}{Inhalts- und Bestandteilübersicht}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{c X l r}
        \toprule
        \textbf{Pos.} & \textbf{Bestandteil} & \textbf{Enthalten im e-Portfolio von} & \textbf{Empf. Umfang} \\
        \midrule
        1 & Titel & allen Gruppenmitgliedern & max. 1 Seite \\
        2 & Logbuch & allen Gruppenmitgliedern & --- \\
        3 & Zusammenfassung des Logbuchs & allen Gruppenmitgliedern & max. 4 Seiten \\
        4 & Einschätzung der Gruppenmitglieder & allen Gruppenmitgliedern & max. 1 Seite \\
        5 & Ergebnisse der Gruppe & Sprecherin der Gruppe & max. 3 Seiten \\
        6 & Protokoll der Gruppentreffen & Sprecherin der Gruppe & ca. 1--2 Seiten \\
        7 & Quellen und Hilfsmittel & allen Gruppenmitgliedern & ca. 1 Seite \\
        \bottomrule
    \end{tabularx}
\end{table}
